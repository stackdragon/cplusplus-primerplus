...
// input. A sample run might look like this: Enter a string(q to quit) : go away GO AWAY
// Next string(q to quit) : good grief! GOOD GRIEF! Next string(q to quit) : q Bye.
